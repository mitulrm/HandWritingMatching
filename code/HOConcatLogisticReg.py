...
def HOConcatLogisticReg(x_train, x_val, x_test, y_train, y_val, y_test, verbose):
    print('--------- Human Observed Concatenate Logistic Regression ---------')
    ...
    plot = df.plot()
    plt.savefig('HO_Concat_Logistic.jpg',grid=True, figsize=(7,8))