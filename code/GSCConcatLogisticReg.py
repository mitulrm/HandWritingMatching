...
def GSCConcatLogisticReg(x_train,x_val,x_test,y_train,y_val,y_test,verbose):
    print('--------- GSC Concatenated Logistic Regression ---------')
    ...
    plot = df.plot()
    plt.savefig('GSC_Concat_Logistic.jpg',grid=True, figsize=(7,8))
